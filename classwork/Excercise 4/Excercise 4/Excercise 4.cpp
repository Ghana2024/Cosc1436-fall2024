// Excercise 4.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
//    int count = promptForNumbers(number, MAX_NUMBERS);
//    
//    choice = displayMenu();
//    switch (choice) {
//        case '1':
//            displayValues(number, count);
//            break;
//        case '2':
//            count = addMoreValues(number, count, MAX_NUMBERS);
//            break;
//        case '3':
//            if (count > 0) {
//                cout << "Largest value: " << getLargestValue(number, count) << endl;
//            } else {
//                cout << "No values entered." << endl;
//            }
//            break;
//        case '4':
//            if (count > 0) {
//                cout << "Smallest value: " << getSmallestValue(number, count) << endl;
//            } else {
//                cout << "No values entered." << endl;
//            }
//            break;
//        case '5':
//            cout << "Sum of values: " << getSumOfValues(number, count) << endl;
//            break;
//        case '6':
//            if (count > 0) {
//                cout << "Mean of values: " << fixed << setprecision(4) << getMeanOfValues(number, count) << endl;
//            } else {
//                cout << "No values entered." << endl;
//            }
//            break;
